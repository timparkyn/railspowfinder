...
class StationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post stations_url, params: { station: { code: @station.code, location_name: @station.location_name } }
    end
  ...
  test "should update station" do
    patch station_url(@station), params: { station: { code: @station.code, location_name: @station.location_name } }
